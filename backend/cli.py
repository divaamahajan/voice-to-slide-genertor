...
This provides the original CLI functionality using the working main.py approach.
"""
...
def main():
    ...
    # Record audio
    filename, duration = record_audio()
    ...
    stream_transcribe_audio(filename)
    
    print("\n--- Transcription ---")
    print(f"Transcription: {transcribe_audio(filename)}")
